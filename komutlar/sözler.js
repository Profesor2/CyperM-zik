    ...
    if (response.message.header.status_code === 200) {
      message.channel.send({
        embed: {
          ...
          description: response.message.body.lyrics.lyrics_body.replace('******* Cyper Lyrics *******', `Lyricsin tamamını buradan bulabilirsin: [musixmatch.com](${response.message.body.lyrics.backlink_url} 'Musixmatch')`),
          footer: {
            text: `Cyper Müzik`
          }
        }
